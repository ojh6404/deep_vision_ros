...
from deep_vision_ros.model_base import InferenceConfigBase

CHECKPOINT_ROOT = os.path.join(rospkg.RosPack().get_path("deep_vision_ros"), "trained_data")
...
class VLPartConfig(ROSInferenceModelConfig):
    ...
    model_root = rospkg.RosPack().get_path("deep_vision_ros") + "/VLPart"
...
class MaskDINOConfig(ROSInferenceModelConfig):
    ...
    confidence_threshold: float = 0.7
    model_root = rospkg.RosPack().get_path("deep_vision_ros") + "/MaskDINO"
...
class OneFormerConfig(ROSInferenceModelConfig):
    ...
    confidence_threshold: float = 0.7
    task: str = "panoptic"
    model_root = rospkg.RosPack().get_path("deep_vision_ros") + "/OneFormer"
